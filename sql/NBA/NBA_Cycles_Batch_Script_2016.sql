DELIMITER $$
 DROP PROCEDURE IF EXISTS pr_run_nba_cycles_batch_2016 $$
 CREATE PROCEDURE pr_run_nba_cycles_batch_2016()
 BEGIN
   ...
   DECLARE nba_cursor CURSOR FOR
     SELECT DISTINCT game_id FROM nba_2016 WHERE game_id >= 21500300 ORDER BY game_id;
   ...
   nba_loop: LOOP
	 ...
	 SET nba.player_load_cycles = fn_nba_get_player_fatigue(nba2.game_id, nba2.play_id, nba2.player, 2016)
